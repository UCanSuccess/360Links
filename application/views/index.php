...
<head>
    ...
    <link rel="stylesheet" href="<?php echo base_url();?>/bower_components/perfect-scrollbar/css/perfect-scrollbar.min.css">
    ...
    <link rel="stylesheet" href="<?php echo base_url();?>/bower_components/angular-ui-switch/angular-ui-switch.min.css">
    <!-- Angular Toaster Css -->
    <link rel="stylesheet" href="<?php echo base_url();?>/bower_components/AngularJS-Toaster/toaster.css">
    <!-- Angular Ng-Aside Css -->
    <link rel="stylesheet" href="<?php echo base_url();?>/bower_components/angular-aside/dist/css/angular-aside.min.css">
    <!-- Angular Notification Icons Css -->
    <link rel="stylesheet" href="<?php echo base_url();?>/bower_components/angular-notification-icons/dist/angular-notification-icons.min.css">
    <!-- V-Accordion Css -->
    <link rel="stylesheet" href="<?php echo base_url();?>/bower_components/v-accordion/dist/v-accordion.min.css">
    <!-- V-Button Css -->
    <link rel="stylesheet" href="<?php echo base_url();?>/bower_components/v-button/dist/v-button.min.css">
    <!-- Sweet Alert Css -->
    <link rel="stylesheet" href="<?php echo base_url();?>/bower_components/sweetalert/lib/sweet-alert.css">
    <!-- Ladda Buttons Css -->
    <link rel="stylesheet" href="<?php echo base_url();?>/bower_components/ladda/dist/ladda-themeless.min.css">
    <!-- Angular Awesome Slider Css -->
    <link rel="stylesheet" href="<?php echo base_url();?>/bower_components/angular-awesome-slider/dist/css/angular-awesome-slider.min.css">
    <!-- Slick Carousel Css -->
...
<body ng-controller="AppCtrl">
    ...
    <!-- Modernizr -->
    <script src="<?php echo base_url();?>/bower_components/components-modernizr/modernizr.js"></script>
    <!-- Moment -->
    ...
    <!-- Sweet Alert -->
    <script src="<?php echo base_url();?>/bower_components/sweetalert/lib/sweet-alert.min.js"></script>
    <!-- Spin -->
    <script src="<?php echo base_url();?>/bower_components/spin.js/spin.js"></script>
    <!-- Ladda Buttons -->
    <script src="<?php echo base_url();?>/bower_components/ladda/dist/ladda.min.js"></script>
    <!-- Slick Carousel -->
    ...
    <!-- angular social -->
    <script src="<?php echo base_url();?>/bower_components/angularjs-social-login/angularjs-social-login.js"></script>
    <!-- oclazyload -->
    ...
    <!-- angular-swipe -->
    <script src="<?php echo base_url();?>/bower_components/angular-swipe/dist/angular-swipe.min.js"></script>
    <!-- UI Bootstrap -->
    ...
    <script src="<?php echo base_url();?>/bower_components/ng-bs-daterangepicker/dist/ng-bs-daterangepicker.min.js"></script>
    <!-- Angular Truncate -->
    <script src="<?php echo base_url();?>/bower_components/angular-truncate/src/truncate.js"></script>
    <!-- Angular Moment -->
    <script src="<?php echo base_url();?>/bower_components/angular-moment/angular-moment.min.js"></script>
    <!-- Angular ui-switch -->
    <script src="<?php echo base_url();?>/bower_components/angular-ui-switch/angular-ui-switch.min.js"></script>
    <!-- Angular Ladda -->
    <script src="<?php echo base_url();?>/bower_components/angular-ladda/dist/angular-ladda.min.js"></script>
    <!-- Angular Toaster -->
    <script src="<?php echo base_url();?>/bower_components/AngularJS-Toaster/toaster.js"></script>
    <!-- Angular Ng-Aside -->
    <script src="<?php echo base_url();?>/bower_components/angular-aside/dist/js/angular-aside.min.js"></script>
    <!-- V-Accordion -->
    <script src="<?php echo base_url();?>/bower_components/v-accordion/dist/v-accordion.min.js"></script>
    <!-- V-Button -->
    <script src="<?php echo base_url();?>/bower_components/v-button/dist/v-button.min.js"></script>
    <!-- Angular Sweet Alert -->
    <script src="<?php echo base_url();?>/bower_components/angular-sweetalert-promised/SweetAlert.min.js"></script>
    <!-- Angular Notification Icons -->
    <script src="<?php echo base_url();?>/bower_components/angular-notification-icons/dist/angular-notification-icons.min.js"></script>
    <!-- Angular Awesome Slider -->
    <script src="<?php echo base_url();?>/bower_components/angular-awesome-slider/dist/angular-awesome-slider.min.js"></script>
    <!-- Angular Slick Carousel -->
    <script src="<?php echo base_url();?>/bower_components/angular-slick-carousel/dist/angular-slick.min.js"></script>
    <!-- Packet Scripts -->
