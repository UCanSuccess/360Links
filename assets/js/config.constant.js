...
app.constant('base_url','http://localhost');
app.constant('JS_REQUIRES', {
    ...
    scripts: {
        ...
        'detailCtrl' : 'assets/js/controllers/detailCtrl.js',
        'friendCtrl' : 'assets/js/controllers/friendCtrl.js',
        'verifyCtrl' : 'assets/js/controllers/verifyCtrl.js',
        'verifyDetailCtrl' : 'assets/js/controllers/verifyDetailCtrl.js',
