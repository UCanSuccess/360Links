...
function ($rootScope, $state, $stateParams) {
    ...
    $rootScope.app = {
        name: '360Link', // name of your project
        author: 'Developer', // author's name or company name
        description: 'Endorse Business Site', // brief description
...
app.config(function(socialProvider){
    socialProvider.setFbKey({appId: "265793400559545", apiVersion: "v2.9"});
});